...
As visible in Figure~\\ref{fig:idea_generation_time_fit}, these HDIs are non-overlapping, with between-category idea generation taking significantly more time. This relationship holds in %i of 10 tests under error simulation. Between-category instance generation took an average of %0.2f seconds longer than within-category. This is inconsistent with the Nijstad and Stoebe finding of 6-12 seconds. This suggests that some property of brainstorming in microtask marketplaces either reduces the impact of category-switching or increases the cost of generating each idea. Further work is necessary to distill these influences."""

    wthn_mu_sec = mu_wthn_post[0]
    btwn_mu_sec = mu_btwn_post[0]
