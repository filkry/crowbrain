...
One researcher coded the data for category in a hierarchical scheme. For each question, ideas recieved from the participants were organized in a tree structure. A single node in the tree represents a particular solution to the problem, and has zero more associated, identical responses.
