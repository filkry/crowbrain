...
We must also consider time spent in light of the hypotheses made by Nijstad and Stroede \cite{nijstad_how_2006}. The second, \textbf{Hypothesis 5}, states that idea generation when changing semantic categories should take longer than idea generation within categories.
